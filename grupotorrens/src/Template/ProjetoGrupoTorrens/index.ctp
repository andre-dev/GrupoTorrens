    ...
    <div class="navbar navbar-default navbar-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a href="index.php"><img src="asset/images/logo.png" class="img-responsive" alt="Logo da empresa"></a>
            ...
            <div class="overlay">
                <div class="container">
                    <div class="intro-text">
                        ...
                        <a href="quemSomos.php" class="page-scroll btn btn-primary">Saiba mais</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 wow zoomIn" data-wow-duration="2s" data-wow-delay="300ms">
                    <a href="servicos.php#painelIG"><p>Por aqui você tera acesso <br> Ao Infográfico relacionado de <br>Custos de um funcionário de RH bla bla bla ...</p></a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="services-post">
				            <a href="servicos.php#painelDP"><i class="fa fa-user"></i></a>
                    ...
                    <div class="col-md-3">
                        <div class="services-post">
				            <a href="servicos.php#painelCRH"><i class="fa fa-sitemap"></i></a>
                    ...
                    <div class="col-md-3">
                        <div class="services-post">
				            <a href="servicos.php#painelRH"><i class="fa fa-users"></i></a>
                    ...
                    <div class="col-md-3">
                        <div class="services-post">
				            <a href="vagas.php"><i class="fa fa-desktop"></i></a>
				            <h2>PORTAL VAGAS</h2>
                    ...
                    <div class="col-md-3">
                        <div class="services-post">
				            <a href="servicos.php#painelFolha"><i class="fa fa-slideshare"></i></a>
                    ...
                    <div class="col-md-3">
                        <div class="services-post">
				            <a href="servicos.php#painelSW"><i class="fa fa-connectdevelop"></i></a>
                    ...
                    <div class="col-md-3">
                        <div class="services-post">
				            <a href="servicos.php#painelMEI"><i class="fa fa-line-chart"></i></a>
                    ...
                    <div class="col-md-3">
                        <div class="services-post">
				            <a href="servicos.php#painelIRPF"><i class="fa fa-paw"></i></a>
