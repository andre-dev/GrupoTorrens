        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right ajusteTop">
                    ...
                    <li>
                        <a class="active" href="quemSomos.ctp">Quem Somos</a>
                    </li>
                    <li>
            ...
            <div class="row">
               ...
               <div class="col-md-7">
                   ...
                   <div class="about-list">
                       ...
                       <h4>Agilidade </h4>
                       <ul>
                           <li class="justificarTexto"><i class="fa fa-check-square"></i>Estamos sempre prontos a atender nossos clientes através do nosso portal WEB, e-mail ou telefone, as informações que você precisa sempre a mão, como se esse departamento estivesse dentro da empresa, temos funcionários qualificados e atualizados para auxiliar nas soluções dos problemas.</li>
                       </ul>

                       <h4>Segurança </h4>
                       <ul>
                           <li class="justificarTexto"><i class="fa fa-check-square"></i>As informações dos nossos clientes são totalmente confidenciais, somente nossa equipe terá acessos ou pessoas autorizadas pelo nosso cliente.</li>
                       </ul>

                       <h4>Tecnologia </h4>
                       <ul>
                           <li class="justificarTexto"><i class="fa fa-check-square"></i>Nossos colaboradores são especializados e atualizados constantemente sobre legislação trabalhista, utilizamos programas de ultima geração, fornecemos relatórios para a tomada de decisão e disponibilizamos um portal web para nossos clientes e seus colaboradores terem acesso a informações essenciais.</li>
                       </ul>
                   </div>
